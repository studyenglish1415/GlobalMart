...
const fetchProducts = () => {
  products.value = [
    ...
    { id: 8, name: 'iPhone 16', price: 6999, image: '/images/iphone%2016.png', rating: 4.9 },
...
.search-bar input {
  flex: 1; padding: 14px 18px; border: none; border-radius: 10px; font-size: 1rem; outline: none;
}
.search-bar button {
  padding: 14px 28px; background: #ff6b6b; color: white; border: none;
