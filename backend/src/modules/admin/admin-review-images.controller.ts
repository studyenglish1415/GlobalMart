...
@ApiTags('Admin - ReviewImages')
@Controller('admin/review-images')
@UseGuards(JwtAuthGuard, AdminGuard)
@ApiBearerAuth('access-token')
export class AdminReviewImagesController {
  constructor(@InjectRepository(ReviewImage) private repo: Repository<ReviewImage>) {}
