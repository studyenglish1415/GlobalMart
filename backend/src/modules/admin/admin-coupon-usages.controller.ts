...
@ApiTags('Admin - CouponUsages')
@Controller('admin/coupon-usages')
@UseGuards(JwtAuthGuard, AdminGuard)
@ApiBearerAuth('access-token')
export class AdminCouponUsagesController {
  constructor(@InjectRepository(CouponUsage) private repo: Repository<CouponUsage>) {}
